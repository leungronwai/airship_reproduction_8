...
"""
Physical model calculation module - contains the calculation of mass, inertia, and aerodynamic characteristics
...
def calculate_added_mass_inertia(a1, a2, b, rho_air_):
    ...
    if abs(a - b) < tolerance:
        ...
        if (1.0 - (b**2 / (a))) < 0:
            # This should not happen in a >= b unless there is a numerical error
            ...
            # Avoid e close to 1 (to avoid division by zero in f)
            if abs(1.0 - _e) < tolerance:
                raise ValueError("Eccentricity e approaches 1 (invalid geometry)")
            ...
            # k1 (Eq. 49)
            denominator_k1 = 2.0 - alpha_  # denominator
            ...
            if abs(term2_den_k3) < tolerance:
                ...
                if abs(a - b) > tolerance:
                    raise ValueError("Small denominator in k3 calculation.")
