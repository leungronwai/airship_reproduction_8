...
T_SPAN = 100  # simulation total time (Total simulation time) [s] # Reduced for faster testing, original paper used longer

# --- (Physical Parameters - Placeholder Values!) ---
m = 6400  # mass (Mass) [kg] - Placeholder
...
rp_r = np.array([[0.8 * airship_a1], [airship_b],
                 [2.0]])  # thrust point in front right down (Thrust point in front right down) - Placeholder
rp_l = np.array([[0.8 * airship_a1], [-airship_b],
                 [2.0]])  # thrust point in front left down (Thrust point in front left down) - Placeholder
...
def setup_spiral_initial_conditions():
    ...
    yc, _yc_dot, _, _, _ = trajectory.get_spiral_trajectory(0.0)
